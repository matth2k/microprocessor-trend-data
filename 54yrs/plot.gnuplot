...
set output "54-years-processor-trend.eps"
...
set xrange [1970:2025.2]
set yrange [0.2:2e8]
unset mytics

set label "Number of"     at 2026,2e1 tc ls 1
set label "Logical Cores" at 2026,6.6e0 tc ls 1

set label "Frequency (MHz)"    at 2026,3e3 tc ls 2

set label "Single-Thread"      at 2026,1.5e5 tc ls 3
set label "Performance"        at 2026,5e4 tc ls 3
set label "(SpecINT x 10^{3})" at 2026,1.9e4 tc ls 3

set label "Transistors"   at 2026,6e6 tc ls 4
set label "(thousands)"   at 2026,2e6 tc ls 4

set label "Typical Power" at 2026,3e2 tc ls 5
set label "(Watts)"       at 2026,1e2 tc ls 5

set title "54 Years of Microprocessor Trend Data"
...
set label "New plot and data collected for 2022-2024 by M. Hofmann" at 2000,3e-3 tc ls 1 font ",8"
